"""Support for Fimer/ABB/Aurora Power-One Solar Photovoltaic (PV) inverter."""
...
async def async_setup_entry(
    ...
    """Set up fimer_abb_aurora_power_one_pvi sensor based on a config entry."""
...
class AuroraSensor(CoordinatorEntity[AuroraAbbDataUpdateCoordinator], SensorEntity):
    """Representation of a Sensor on a Fimer/ABB/Aurora Power-One Solar inverter."""
