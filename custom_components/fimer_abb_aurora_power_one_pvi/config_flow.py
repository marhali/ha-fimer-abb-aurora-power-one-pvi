"""Config flow for Fimer/ABB/Aurora Power-One integration."""
...
async def async_scan_comports(
    ...
    com_ports = await hass.async_add_executor_job(
        serial.tools.list_ports.comports, True
    )
    com_ports_list = []
...
class AuroraABBConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Fimer/ABB/Aurora Power-One."""
