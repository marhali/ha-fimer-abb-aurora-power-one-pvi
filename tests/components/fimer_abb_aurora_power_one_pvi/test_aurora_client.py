"""Tests for the fimer_abb_aurora_power_one_pvi AuroraClient abstraction."""
...
@patch(
    "custom_components.fimer_abb_aurora_power_one_pvi.aurora_client.AuroraSerialClient"
)
...
@patch("custom_components.fimer_abb_aurora_power_one_pvi.aurora_client.AuroraTCPClient")
